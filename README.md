...
<p align="center">
 Filtering: <br/>
Tcpdump has a feature for filtering packets. With this feature I can capture only the traffic that I really want to analyze. I'll use filtering to capture DNS traffic to a specific DNS server. I will use the command:
